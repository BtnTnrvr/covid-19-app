          ...
          slivers: <Widget>[
            ...
            SliverFillRemaining(
              child: Column(children: <Widget>[
                DetailCard(
                  heading: "Toplam Ölümler",
                  iconColor: Colors.red[300],
                  icon: Icons.airline_seat_individual_suite,
                  info: totalDeaths,
                ),
                DetailCard(
                  heading: "Toplam İyileşenler",
                  iconColor: Colors.green,
                  icon: Icons.verified_user,
                  info: int.parse(totalRecoverd),
                ),
                DetailCard(
                  heading: "Bugünün Vakaları",
                  info: todayCases,
                  icon: Icons.assignment,
                  iconColor: Colors.blue,
                ),
                DetailCard(
                  heading: "Bugünün Ölümleri",
                  info: todayDeaths,
                  icon: Icons.airline_seat_individual_suite,
                  iconColor: Colors.red[300],
                ),
                DetailCard(
                  heading: "Toplam Testler",
                  info: totalTests,
                  icon: Icons.colorize,
        ...
        child: Stack(
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                Text("Toplam Vakalar", style: TextStyle(fontSize: height * 0.027)),
