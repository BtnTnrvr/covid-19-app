...
import 'package:covid19/views/turkey.dart';
...
class _DashboardState extends State<Dashboard> with TickerProviderStateMixin {
  int currentIndex = 0;
  final List<Widget> children = [World(), turkey(), Country(), About()];
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              ...
              title:
                  Text("Türkiye", style: TextStyle(fontFamily: 'MyFont'))),
          BottomNavigationBarItem(
              icon: Icon(Icons.flag),
              title: Text("Ülkeler", style: TextStyle(fontFamily: 'MyFont'))),
          BottomNavigationBarItem(
              activeIcon: RotationTransition(
                turns: Tween(begin: 0.0, end: 1.0).animate(_controller),
              ...
              title: Text("Hakkında", style: TextStyle(fontFamily: 'MyFont')))
        ],
      ),
      body: currentIndex == 0
          ? SafeArea(
